...
export default function Header({ doctor, patientAppointment }) {
  return (
    <>
          ...
          <ul className="timeline">
            <li>
              ...
              >
                ...
                <p className="fs-14 mb-0">{patientAppointment?.length}</p>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <p className="fs-14 mb-0">10/02/2025, 10:45 AM</p>
              </a>
            </li>
          </ul>
        </div>
